      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 backdrop-blur-sm">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-mono font-semibold text-slate-300">Total Tickets</h3>
            </div>
        ...
        <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl backdrop-blur-sm">
          <div className="p-6 border-b border-slate-700/50">
            <h2 className="text-2xl font-mono font-bold text-white">Reported Tickets</h2>
            <p className="text-slate-400 font-mono mt-1">Manage and review user tickets</p>
          </div>
          ...
          <div className="p-6">
            {reports.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-slate-400 font-mono text-lg">No tickets found</p>
